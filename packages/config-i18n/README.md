# `@sbercloud/ft-config-i18n`

> Установка: `npm i @sbercloud/ft-config-i18n`
>
...
```typescript
// i18n.ts 
import { i18nConfig } from '@sbercloud/ft-config-i18n';
...
> Ранее использовался пакет `@sbercloud/ft-typed-language-dictionary`. 
> 
...
```typescript
import { typedDictionary } from '@sbercloud/ft-config-i18n';
